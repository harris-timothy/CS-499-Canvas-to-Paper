...
public class RelationType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "kind", namespace = "http://www.imsglobal.org/xsd/imsmd_v1p2", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "resource", namespace = "http://www.imsglobal.org/xsd/imsmd_v1p2", type = JAXBElement.class, required = false)
    })
    @XmlMixed
     ...
     * {@link JAXBElement }{@code <}{@link KindType }{@code >}
