...
public class QuestionBankRecord extends UpdatableRecordImpl<QuestionBankRecord> implements Record5<Integer, String, Integer, String, Integer> {
    ...
    @Override
    public QuestionBankRecord value5(Integer value) {
        setCourseId(value);
        return this;
    }

    @Override
    public QuestionBankRecord values(Integer value1, String value2, Integer value3, String value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public QuestionBankRecord(Integer id, String name, Integer apiId, String qtiId, Integer courseId) {
        super(QuestionBank.QUESTION_BANK);
